"""
Take a randomly generated list and return a new list with all duplicated numbers removed.
Using 2 functions, one using loop to  construct a list and one using sets. 
"""

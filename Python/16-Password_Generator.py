"""
A password generator that can generate both weak or strong password depending on user preference. 
Password is random everytime the program runs.
Run-time code must be included in the main method.
"""
